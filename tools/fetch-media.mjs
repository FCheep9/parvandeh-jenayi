...
const slots = [
  ...
  { id: 'loc-office',        q: 'modern office glass meeting room' },
  { id: 'loc-archive',       q: 'basement archive shelves tapes' },
  { id: 'ev-freezer',        q: 'chest freezer open' },
  { id: 'ev-receipt',        q: 'store receipt paper' },
  { id: 'ev-parking',        q: 'parking garage ticket' },
  { id: 'ev-laptop',         q: 'laptop screen office desk' },
  { id: 'ev-phone',          q: 'smartphone screen hand' },
